...
mod tests {
    ...
    fn test_movsb_forward() {
        ...
        // Write test data
        cpu.memory.write_byte((cpu.regs.ds as u32) << 4 | 0x0100, 0x42);
        
        assert!(cpu.movsb().is_ok());
        
        // Check that byte was moved
        assert_eq!(cpu.memory.read_byte((cpu.regs.es as u32) << 4 | 0x0200), 0x42);
    ...
    fn test_movsw_forward() {
        ...
        assert_eq!(cpu.memory.read_word((cpu.regs.es as u32) << 4 | 0x0200), 0x1234);
    ...
    fn test_cmpsb_equal() {
        ...
        // Write test data
        cpu.memory.write_byte((cpu.regs.ds as u32) << 4 | 0x0100, 0x42);
        cpu.memory.write_byte((cpu.regs.es as u32) << 4 | 0x0200, 0x42);
